...
T = TypeVar("T", bound="SignCertificateBody")
...
class SignCertificateBody:
    ...
    Attributes:
        ...
        revoke_existing (Union[Unset, str]): Revoke existing iOS Development certificates first.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sign_certificate_body.additional_properties = d
        return sign_certificate_body
