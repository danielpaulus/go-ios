...
T = TypeVar("T", bound="DevicesMdmFetchUnlockTokenBody")


@_attrs_define
class DevicesMdmFetchUnlockTokenBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        devices_mdm_fetch_unlock_token_body = cls(
            p12=p12,
            password=password,
        )

        devices_mdm_fetch_unlock_token_body.additional_properties = d
        return devices_mdm_fetch_unlock_token_body
