...
from ...models.device_name import DeviceName
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/devicename".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[DeviceName, GenericResponse]]:
    if response.status_code == 200:
        response_200 = DeviceName.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DeviceName, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DeviceName, GenericResponse]
    """
