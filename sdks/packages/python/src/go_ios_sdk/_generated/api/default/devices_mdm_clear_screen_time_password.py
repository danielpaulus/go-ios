...
from ...models.devices_mdm_clear_screen_time_password_body import (
...
def _get_kwargs(
    udid: str,
    *,
    body: DevicesMdmClearScreenTimePasswordBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/device/{udid}/mdm/clear-screen-time-password".format(
            udid=udid,
        ),
    }
