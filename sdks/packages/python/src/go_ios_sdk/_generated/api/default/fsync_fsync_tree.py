...
from ...models.fsync_tree_listing import FsyncTreeListing
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/fsync/tree".format(
            udid=udid,
        ),
        "params": params,
    }
...
) -> Optional[Union[FsyncTreeListing, GenericResponse]]:
    if response.status_code == 200:
        response_200 = FsyncTreeListing.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[FsyncTreeListing, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[FsyncTreeListing, GenericResponse]
    """
