...
from ...models.icon_layout import IconLayout
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/icon-layout".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[GenericResponse, IconLayout]]:
    if response.status_code == 200:
        response_200 = IconLayout.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GenericResponse, IconLayout]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[GenericResponse, IconLayout]
    """
