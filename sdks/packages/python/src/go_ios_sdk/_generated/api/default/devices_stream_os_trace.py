...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/ostrace".format(
            udid=udid,
        ),
        "params": params,
    }
...
) -> Optional[Union[GenericResponse, str]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GenericResponse, str]]:
    return Response(
