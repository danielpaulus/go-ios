...
from ...models.ui_long_press_request import UILongPressRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/device/{udid}/ui/longpress".format(
            udid=udid,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UILongPressRequest): `POST /device/{udid}/ui/longpress` request — press and hold at
            (x,y).
