...
from ...models.ui_type_request import UITypeRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/device/{udid}/ui/type".format(
            udid=udid,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UITypeRequest): `POST /device/{udid}/ui/type` request — keyboard input.
