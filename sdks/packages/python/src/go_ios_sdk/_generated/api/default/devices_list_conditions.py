...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/conditions".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[GenericResponse, list["ProfileType"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ProfileType.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GenericResponse, list["ProfileType"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[GenericResponse, list['ProfileType']]
    """
