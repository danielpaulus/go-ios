...
from ...models.file_listing import FileListing
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/files".format(
            udid=udid,
        ),
        "params": params,
    }
...
) -> Optional[Union[FileListing, GenericResponse]]:
    if response.status_code == 200:
        response_200 = FileListing.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[FileListing, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[FileListing, GenericResponse]
    """
