...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/diagnostics".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[Diagnostics, GenericResponse]]:
    if response.status_code == 200:
        response_200 = Diagnostics.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Diagnostics, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Diagnostics, GenericResponse]
    """
