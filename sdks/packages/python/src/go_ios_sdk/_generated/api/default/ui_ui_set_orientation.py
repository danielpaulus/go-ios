...
from ...models.ui_orientation_request import UIOrientationRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/device/{udid}/ui/orientation".format(
            udid=udid,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UIOrientationRequest): `PUT /device/{udid}/ui/orientation` request.
