...
from ...models.battery_info import BatteryInfo
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/battery".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[BatteryInfo, GenericResponse]]:
    if response.status_code == 200:
        response_200 = BatteryInfo.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[BatteryInfo, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[BatteryInfo, GenericResponse]
    """
