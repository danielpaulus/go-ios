...
from ...models.device_date import DeviceDate
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/date".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[DeviceDate, GenericResponse]]:
    if response.status_code == 200:
        response_200 = DeviceDate.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DeviceDate, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DeviceDate, GenericResponse]
    """
