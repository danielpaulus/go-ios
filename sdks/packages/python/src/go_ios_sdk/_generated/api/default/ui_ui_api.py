...
from ...models.uiapi_request import UIAPIRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/device/{udid}/ui/api".format(
            udid=udid,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UIAPIRequest): `POST /device/{udid}/ui/api` request — raw passthrough to the backend
