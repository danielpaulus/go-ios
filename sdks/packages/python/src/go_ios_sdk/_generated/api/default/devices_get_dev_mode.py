...
from ...models.dev_mode_state import DevModeState
...
) -> Optional[Union[DevModeState, GenericResponse]]:
    if response.status_code == 200:
        response_200 = DevModeState.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DevModeState, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DevModeState, GenericResponse]
    """
