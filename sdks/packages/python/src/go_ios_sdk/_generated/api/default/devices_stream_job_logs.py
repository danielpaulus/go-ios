...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/jobs/{id}/logs".format(
            udid=udid,
            id=id,
        ),
    }
...
) -> Optional[Union["GenericResponse", GenericResponse, str]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union["GenericResponse", GenericResponse, str]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union['GenericResponse', GenericResponse, str]
    """
