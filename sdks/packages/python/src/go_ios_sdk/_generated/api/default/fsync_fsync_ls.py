...
from ...models.fsync_listing import FsyncListing
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/fsync/ls".format(
            udid=udid,
        ),
        "params": params,
    }
...
) -> Optional[Union[FsyncListing, GenericResponse]]:
    if response.status_code == 200:
        response_200 = FsyncListing.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[FsyncListing, GenericResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[FsyncListing, GenericResponse]
    """
