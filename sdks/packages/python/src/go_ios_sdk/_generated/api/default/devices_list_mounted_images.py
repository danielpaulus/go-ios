...
from ...models.mounted_images import MountedImages
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/device/{udid}/image/list".format(
            udid=udid,
        ),
    }
...
) -> Optional[Union[GenericResponse, MountedImages]]:
    if response.status_code == 200:
        response_200 = MountedImages.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GenericResponse, MountedImages]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[GenericResponse, MountedImages]
    """
