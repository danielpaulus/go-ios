...
namespace GoIos.Sdk.Generated.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemLimitResult")]
    public partial class MemLimitResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemLimitResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MemLimitResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MemLimitResult" /> class.
        /// </summary>
        ...
        public MemLimitResult(string process = default, int pid = default, bool disabled = default)
        {
            // to ensure "process" is required (not null)
            if (process == null)
            {
                throw new ArgumentNullException("process is a required property for MemLimitResult and cannot be null");
            }
