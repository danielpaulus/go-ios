 ...
 */
@JsonPropertyOrder({
  SyslogMessage.JSON_PROPERTY_MESSAGE,
  SyslogMessage.JSON_PROPERTY_TIMESTAMP
})
...
public class SyslogMessage {
  ...
  public SyslogMessage message(@jakarta.annotation.Nonnull String message) {
  ...
  public SyslogMessage timestamp(@jakarta.annotation.Nullable Long timestamp) {
  ...
  /**
   * Return true if this SyslogMessage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SyslogMessage syslogMessage = (SyslogMessage) o;
    return Objects.equals(this.message, syslogMessage.message) &&
        Objects.equals(this.timestamp, syslogMessage.timestamp);
  }
