...
import com.github.danielpaulus.goios.generated.model.FileEntry;
 ...
 */
@JsonPropertyOrder({
  FileListing.JSON_PROPERTY_PATH,
  FileListing.JSON_PROPERTY_FILES,
  FileListing.JSON_PROPERTY_COUNT
})
...
public class FileListing {
  ...
  public FileListing path(@jakarta.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public FileListing files(@jakarta.annotation.Nonnull List<FileEntry> files) {
    this.files = files;
    return this;
  }

  public FileListing addFilesItem(FileEntry filesItem) {
    if (this.files == null) {
  ...
  @JsonProperty(JSON_PROPERTY_FILES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFiles(@jakarta.annotation.Nonnull List<FileEntry> files) {
    this.files = files;
  }


  public FileListing count(@jakarta.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, fileListing.path) &&
        Objects.equals(this.files, fileListing.files) &&
        Objects.equals(this.count, fileListing.count);
  }
