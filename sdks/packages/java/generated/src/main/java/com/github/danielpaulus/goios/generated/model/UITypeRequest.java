 ...
 */
@JsonPropertyOrder({
  UITypeRequest.JSON_PROPERTY_TEXT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class UITypeRequest {
  public static final String JSON_PROPERTY_TEXT = "text";
  @jakarta.annotation.Nonnull
  private String text;

  public UITypeRequest() { 
  }

  public UITypeRequest text(@jakarta.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  /**
   * Return true if this UITypeRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UITypeRequest uiTypeRequest = (UITypeRequest) o;
    return Objects.equals(this.text, uiTypeRequest.text);
  }
