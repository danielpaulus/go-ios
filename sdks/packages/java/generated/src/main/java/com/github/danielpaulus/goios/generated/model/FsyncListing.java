 ...
 */
@JsonPropertyOrder({
  FsyncListing.JSON_PROPERTY_PATH,
  FsyncListing.JSON_PROPERTY_FILES,
  FsyncListing.JSON_PROPERTY_COUNT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class FsyncListing {
  ...
  public FsyncListing path(@jakarta.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public FsyncListing files(@jakarta.annotation.Nonnull List<String> files) {
    this.files = files;
    return this;
  }

  public FsyncListing addFilesItem(String filesItem) {
    if (this.files == null) {
  ...
  public FsyncListing count(@jakarta.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  /**
   * Return true if this FsyncListing object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FsyncListing fsyncListing = (FsyncListing) o;
    return Objects.equals(this.path, fsyncListing.path) &&
        Objects.equals(this.files, fsyncListing.files) &&
        Objects.equals(this.count, fsyncListing.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, files, count);
  }
